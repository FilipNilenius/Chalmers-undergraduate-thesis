...
% secondary language
% You only need to use this if you (1) are writing a bachelor thesis in Swedish which should have an English abcstract, or (2) if you are writing a Master's thesis and want to include a Swedish abstract (which is optional).
